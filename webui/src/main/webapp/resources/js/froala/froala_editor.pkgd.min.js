...
!function (a) {
    ...
    if (b.DEFAULTS = {
        ...
        function f() {
            h = b.image.get()[0], g.launch({image: h, url: h.src})
        }

        var g, h;
        return {_init: d, launch: f}
    },a.FE.DefineIcon("aviary", {NAME: "sliders"}),a.FE.RegisterCommand("aviary", {
        title: "Advanced Edit",
        undo: !1,
        focus: !1,
        callback: function (a, b) {
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        function d(a) {
            "bold" != a && "italic" != a && "underline" != a && "strikeThrough" != a && "subscript" != a && "superscript" != a && "fontFamily" != a && "fontSize" != a || i.removeMarkupInSelectionNode({removeInside: !0}), "html" == a && g()
        }
        ...
        function f() {
            var c = b.selection.ranges(0), f = c.startContainer;
            if (!f || f.nodeType !== Node.TEXT_NODE)return !1;
            if (d().test(f.textContent)) a(f).before(e(f.textContent)), f.parentNode.removeChild(f); else if (f.previousSibling && "A" === f.previousSibling.tagName) {
        ...
        function n(a, b) {
            ...
            var e = d ? "ol" : "ul", f = l(a), g = "<" + e + "><li>" + m(a, b), i = a.nextElementSibling, j = a.parentNode;
            for (h(a), a = null; i && k(i);) {
                var o = i.previousElementSibling, p = l(i);
                if (p > f) g += n(i, b).outerHTML; else {
                    if (p < f)break;
                    g += "</li><li>" + m(i, b)
                }
                            ...
                            if (!(i && i.length < 2)) {
                                ...
                                if (i[0].indexOf("pngblip") != -1 ? j = "image/png" : i[0].indexOf("jpegblip") != -1 && (j = "image/jpeg"), j) {
                                    ...
                                    if (!(k && k.length < 2)) {
                                        ...
                                        var m = l.join(""), n = w(m), o = "data:" + j + ";base64," + n;
        ...
        function y(c, d) {
            var e = c.tagName, f = e.toLowerCase();
            ...
            for (i = 0; i < j.length; i++)if (e.indexOf(j[i]) != -1)return c.innerHTML ? (c.outerHTML = c.innerHTML, h(c), !1) : (h(c), !1);
            if ("TD" != e) {
        ...
        function A(c, d) {
            ...
            var e = new DOMParser, f = e.parseFromString(c, "text/html"), g = f.head, j = f.body, l = z(g);
            i(j, function (b) {
                ...
                if (a.nodeType == Node.ELEMENT_NODE) {
                    if (k(a)) {
                        var b = a.parentNode, c = a.previousSibling, d = n(a, l), e = null;
            ...
            var m = j.outerHTML, o = b.opts.htmlAllowedStyleProps;
